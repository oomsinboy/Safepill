...
final _data1 = <double, double>{1: 5, 2: 1, 3: 20, 4: 12, 5: 14, 7: 50};
final _data2 = <double, double>{1: 8, 2: 12, 3: 27, 4: 31, 5: 36, 7: 45};
  ...
  Widget build(BuildContext context) {
    ...
    final lineChartData = LineChartData(
      ...
      axisTitleData: FlAxisTitleData(
        show: true,
        //bottomTitle: AxisTitle(titleText: 'Month', showTitle: false),
